...
Write-Cmd '.\scripts\smoke-test.ps1' 'Run changed-only smoke tests (default)'
Write-Cmd '.\scripts\smoke-test.ps1 -ChangedOnly' 'Run smoke tests affected by changed source/header or shader files'
Write-Cmd '.\scripts\smoke-test.ps1 -Full' 'Run the full discovered smoke suite'
...
Write-Cmd '.\scripts\verify.ps1 -SmokeFull' 'Full verification with every discovered smoke executable'
...
Write-Cmd '.\scripts\smoke-test.ps1 -Full' 'Run every discovered smoke executable'
...
Write-Cmd '.\scripts\verify.ps1 -SmokeChangedOnly' 'Full verification with changed-only smoke selection (default)'
Write-Cmd '.\scripts\verify.ps1 -SmokeFull' 'Full verification with every discovered smoke executable'

...
struct WorldBounds {
     ...
     */
    static WorldBounds fromDirectionalLimits(Meters northLimit, Meters southLimit, Meters westLimit,
                                             Meters eastLimit, Meters upLimit = Meters(0.0f),
                                             Meters downLimit = Meters(0.0f)) {
        // Ensure proper min/max ordering regardless of input order
        WorldPoint minPt(std::min(westLimit.value, eastLimit.value),
     ...
     */
    static WorldBounds flat(Meters northLimit, Meters southLimit, Meters westLimit,
                            Meters eastLimit) {
        return fromDirectionalLimits(northLimit, southLimit, westLimit, eastLimit, Meters(0.0f),
                                     Meters(0.0f));
    }

...
/**
 * @file KeyCodes.h
 * @brief Key code definitions for VDE input handling
 *
 * Platform-independent key codes for keyboard and mouse input.
 * Values are compatible with GLFW key codes.
 */

namespace vde {

// Keyboard key codes (compatible with GLFW)

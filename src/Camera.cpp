...
float Camera::calculateDistanceForContent(float contentWidth, float viewportWidthPercent,
    ...
    const float effectiveWidth =
        2.0f * std::tan(halfFovH) * (1.0f / std::cos(pitchRad)) * viewportWidthPercent;

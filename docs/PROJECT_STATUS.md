...
| Tiled import path | Implemented | [../include/vde/api/TileMapImport.h](../include/vde/api/TileMapImport.h), [../assets/tiled/](../assets/tiled/), [../examples/tilemap_demo/](../examples/tilemap_demo/), [../tests/TileMap_test.cpp](../tests/TileMap_test.cpp) | A documented finite-orthogonal Tiled JSON subset now imports into `TileMap`, including layer translation, embedded image tilesets, object-layer extraction, and explicit failures for unsupported constructs. |
...
| Tile-based content pipeline | `TileMap`, `RepeatingBackground`, and `TileMapImport` now cover runtime tile rendering, finite-orthogonal Tiled JSON import, layer translation, tileset metadata, and extracted solid/one-way collision spans | No external TSX / multiple-tileset import, broader authored metadata like slopes, or general editor-driven level pipeline yet | [../include/vde/api/TileMap.h](../include/vde/api/TileMap.h), [../include/vde/api/TileMapImport.h](../include/vde/api/TileMapImport.h), [../examples/tilemap_demo/](../examples/tilemap_demo/), [REMAINING_ENGINE_DEFICIENCIES.md](REMAINING_ENGINE_DEFICIENCIES.md) |
...
|------|----------------|-------------------------|
| Broader authored tile metadata and authoring workflow | The core Tiled JSON import path is now shipped, but richer authored collision/tag metadata, external TSX support, and editor-grade workflows remain open | [REMAINING_ENGINE_DEFICIENCIES.md](REMAINING_ENGINE_DEFICIENCIES.md), [OPEN_SUGGESTIONS.md](OPEN_SUGGESTIONS.md) |

...
- **Examples:** 41 example directories live under [../examples/](../examples/), with targets registered in [../examples/CMakeLists.txt](../examples/CMakeLists.txt). Coverage spans core rendering, sprites, text, transitions, physics, audio, diagnostics, storage, resources, automation, camera-feel workflows, and multi-viewport scenarios.

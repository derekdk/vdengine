...
| Input handling and automation | Implemented | [../include/vde/api/InputHandler.h](../include/vde/api/InputHandler.h), [../include/vde/api/KeyStateTracker.h](../include/vde/api/KeyStateTracker.h), [../include/vde/api/InputScript.h](../include/vde/api/InputScript.h), [../include/vde/api/InputScriptExecutor.h](../include/vde/api/InputScriptExecutor.h) | Raw input handling, named held/one-shot helpers, and scripted input playback are part of the API. |
...
|------|-----------------|-----------------------|----------|
| Camera2D ergonomics | Positioning, zoom, rotation, viewport sizing, visible-rect calculation, and orthographic application | Deadzone, look-ahead, screen shake, and smooth zoom helpers are not public APIs | [../include/vde/api/GameCamera.h](../include/vde/api/GameCamera.h), [REMAINING_ENGINE_DEFICIENCIES.md](REMAINING_ENGINE_DEFICIENCIES.md) |
...
| Input abstraction | Raw input events and `KeyStateTracker` named held/one-shot bindings | No full action-map layer, rebinding UI/persistence flow, analog deadzone configuration, or buffered action semantics | [../include/vde/api/InputHandler.h](../include/vde/api/InputHandler.h), [../include/vde/api/KeyStateTracker.h](../include/vde/api/KeyStateTracker.h), [REMAINING_ENGINE_DEFICIENCIES.md](REMAINING_ENGINE_DEFICIENCIES.md) |
...
|------|----------------|-------------------------|
| TileMap and tiled-background workflow | Needed for platformers, RPGs, strategy maps, and scalable 2D level construction | [REMAINING_ENGINE_DEFICIENCIES.md](REMAINING_ENGINE_DEFICIENCIES.md), [OPEN_SUGGESTIONS.md](OPEN_SUGGESTIONS.md) |
...
| Input action mapping and rebinding | Needed to remove repeated per-game input glue and support configurable controls | [REMAINING_ENGINE_DEFICIENCIES.md](REMAINING_ENGINE_DEFICIENCIES.md), [ENGINE_API_EVALUATION_2026-05-26.md](ENGINE_API_EVALUATION_2026-05-26.md) |
| Camera2D feel helpers | Needed for deadzone, shake, look-ahead, and smooth zoom in real 2D games | [REMAINING_ENGINE_DEFICIENCIES.md](REMAINING_ENGINE_DEFICIENCIES.md), [OPEN_SUGGESTIONS.md](OPEN_SUGGESTIONS.md) |
...
- **Examples:** 40 example directories live under [../examples/](../examples/), with targets registered in [../examples/CMakeLists.txt](../examples/CMakeLists.txt). Coverage spans core rendering, sprites, text, transitions, physics, audio, diagnostics, storage, resources, automation, and multi-viewport workflows.
